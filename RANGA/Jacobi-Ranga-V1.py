...
n = 5; tolerance = 0.00001;  teste = 1 

print()
print("*******************************")
print("Este programa é para resolver um sistema Ax = b ")
print("  pelo método iterativo de Jacobi.")
#
print()
print("Opção: \33[1;34m0\33[m para entrar os valores da uma matriz")
print("Opção: \33[1;34m1\33[m para usar um exemplo de matriz 3x3 pronto")
print("Opção: \33[1;34m2\33[m para usar um exemplo de matriz 4x4 pronto")
print() 
...
for i in range(0,n+1):
  x.append(0.0);  y.append(0.0);  b.append(0.0);  c.append(0.0)
  A.append([ ]);  B.append([ ])
...
#
#:: Matriz B e vetor c
print(end = "A matriz \33[0;34mB\33[m e vetor \33[0;32mc\33[m no ")
print("sistem x = Bx + c")
#
for i in range (1,n+1): 
  for j in range (1, n+1):
